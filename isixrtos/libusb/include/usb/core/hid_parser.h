...
#ifndef _ISIX_USBLIB_HID_PARSER_H_
#define _ISIX_USBLIB_HID_PARSER_H_


#include <stdint.h>
#include <stdbool.h>
#include <usb/core/hid_class_common.h>
#include <usb/core/hid_report_data.h>
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Type Defines: */
			 ...
			 */
			typedef bool (*usbh_hid_parse_filter_fptr_t)(HID_ReportItem_t* const CurrentItem);
		...
		/* Function Prototypes: */
			 ...
			 *  \param[in]	filter_fun	Filter function callback
			 *
			 *  \return A value in the \ref HID_Parse_ErrorCodes_t enum.
			 */
			int usbh_hid_process_report(const uint8_t* ReportData,
			                             uint16_t ReportSize,
			                             HID_ReportInfo_t* const ParserData,
			                             usbh_hid_parse_filter_fptr_t filter_fun );
			 ...
			 */
			bool usbh_hid_get_report_item_info(const uint8_t* ReportData,
			 ...
			 */
			void usbh_hid_set_report_item_info(uint8_t* ReportData,
			                              HID_ReportItem_t* const ReportItem);
			 ...
			 */
			uint16_t usbh_hid_get_report_size(HID_ReportInfo_t* const ParserData,
