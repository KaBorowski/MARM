...
#ifndef _ISIX_USBLIB_HID_REPORT_DATA_
#define _ISIX_USBLIB_HID_REPORT_DATA_
...
#include <stddef.h>
	...
	/* Private Interface - For use in library only: */
		...
		/* Macros: */
			...
			#define HID_RI_DATA_BITS(DataBits)              _usblib_cat(HID_RI_DATA_BITS_, DataBits)

			#define _HID_RI_ENCODE_0(Data)
			#define _HID_RI_ENCODE_8(Data)                  , (Data & 0xFF)
			#define _HID_RI_ENCODE_16(Data)                 _HID_RI_ENCODE_8(Data)  _HID_RI_ENCODE_8(Data >> 8)
			#define _HID_RI_ENCODE_32(Data)                 _HID_RI_ENCODE_16(Data) _HID_RI_ENCODE_16(Data >> 16)
			#define _HID_RI_ENCODE(DataBits, ...)           _usblib_cat(_HID_RI_ENCODE_, DataBits(__VA_ARGS__))
